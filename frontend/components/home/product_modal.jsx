...
const MODAL_BODY = {
    ...
    6: 'Robbyhood is a site for learning and gaining experience in the stock market.  Data is pull from third party APIs such as IEX Cloud and World Trade Market for most updated and reliable data.  Due to limited API calls per second, some stock data points may be delayed.  Please do not expect exact values in the actual market.'
}
